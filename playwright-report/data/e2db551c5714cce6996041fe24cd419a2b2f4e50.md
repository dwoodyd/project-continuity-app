...
- Name: checkin-flow.spec.ts >> Check-in flow smoke test >> 4 · Thread view — today shows all three dots filled
- Location: e2e/checkin-flow.spec.ts:132:3
...
Call log:
  - waiting for getByText('Your thread this week') to be visible
