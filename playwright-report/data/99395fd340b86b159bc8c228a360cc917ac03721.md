...
- Name: checkin-flow.spec.ts >> Check-in flow smoke test >> 3 · Evening closure — close the day
- Location: e2e/checkin-flow.spec.ts:106:3
...
Call log:
  - waiting for getByRole('button', { name: 'Evening closure' })
    - locator resolved to <button data-loc="client/src/pages/Home.tsx:257" class="flex-1 min-w-0 flex flex-col items-start gap-1.5 p-3 rounded-xl border text-left transition-all duration-150 overflow-hidden bg-primary border-primary hover:bg-primary/90 shadow-md shadow-primary/20 cursor-pointer">…</button>
