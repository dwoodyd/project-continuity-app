...
- Name: checkin-flow.spec.ts >> Check-in flow smoke test >> 2 · Midday check-in — submit alignment pulse
- Location: e2e/checkin-flow.spec.ts:79:3
...
Call log:
  - waiting for getByRole('button', { name: 'Midday check-in' }) to be visible
