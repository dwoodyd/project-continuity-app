      ...
      <div className="max-w-2xl mx-auto px-6 pb-24 pt-12">
        ...
        <div className="text-center mb-14">
          <div className="flex flex-col items-center mb-6">
            <WrenPlayer clip="popsHead" size="hero" stage={false} feather fallbackStill="siliconeWatching" />
        ...
        <div className="mb-12">
          ...
          {/* Hero Wren scene — full-width cinematic presence */}
          <section
            className="relative isolate min-h-[360px] overflow-hidden mb-6 bg-[#161815]"
            style={{ boxShadow: "0 0 60px oklch(0.72 0.14 72 / 0.08)" }}
          >
            {/* Ambient glow */}
            <div
            ...
            <WrenPlayer
              ...
              wrapperClassName="absolute inset-0 scale-110 origin-bottom-right opacity-60 sm:opacity-90"
            />
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true" style={{ background: "linear-gradient(90deg, #161815 0%, rgba(22,24,21,0.92) 42%, rgba(22,24,21,0.26) 100%)" }} />
            <div className="relative z-10 flex min-h-[360px] items-end p-6 text-left sm:p-8">
          ...
          <div className="mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {WREN_TRAITS.map(({ icon: Icon, title, desc, accent, accentBg, accentBorder }) => (
                <div
                  key={title}
