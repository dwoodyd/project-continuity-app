        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              size="sm"
              onClick={() => {
                const text = encodeURIComponent(`${summaryLine}\n\n— via Continuary`);
                window.open(`https://x.com/intent/tweet?text=${text}`, "_blank", "noopener");
              }}
              className="flex-1 gap-1.5 bg-black hover:bg-zinc-800 text-white border-0"
            >
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              Post to X
            </Button>
