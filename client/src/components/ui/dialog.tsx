...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // data-[state=closed]: pointer-events-none ensures that during the fade-out
        // animation the overlay does NOT swallow the next click on underlying elements
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // data-[state=closed]:pointer-events-none prevents the fading-out dialog
          // from swallowing the next pointer event (e.g. clicking sidebar after Esc)
